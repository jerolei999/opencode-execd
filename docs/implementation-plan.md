...
1. Specify and test an OpenCode plugin that transparently overrides `bash`, preserves permission checks and cancellation, and calls the execution service directly.
